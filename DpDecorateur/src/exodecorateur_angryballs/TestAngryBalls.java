...
import exodecorateur_angryballs.modele.BilleMvtNewtonArret;
...
public class TestAngryBalls
{
	...
	public static void main(String[] args)
	{
		...
		billes.add(new BilleMvtRURebond(new BilleNue(p0, rayon , v0, Color.red)));
		billes.add(new BilleMvtPesanteurFrottementRebond(new BilleNue(p1, rayon , v1, Color.yellow), new Vecteur(0,0.001)));
		billes.add(new BilleMvtNewtonFrottementRebond(new BilleNue(p2, rayon , v2, Color.green)));
		billes.add(new BilleMvtRUPasseMurailles(new BilleNue(p3, rayon , v3, Color.cyan)));
		billes.add(new BilleMvtNewtonArret(new BilleNue(p4, rayon , v4, Color.black)));
