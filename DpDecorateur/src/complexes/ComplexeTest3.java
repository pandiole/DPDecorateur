...
///**
// * 
// * dédiée au test des méthodes de la classe Complexe
// * 
// * */
...
//
//Assert.assertTrue(z.getX() ==  z.conjugué().getX() &&
//                  z.getY() == -z.conjugué().getY());
//}
//
//public final void testOpposé()
//{
//Complexe z1 = new Complexe(Reel.random(), Reel.random()); // z1 est quelconque
//
//Assert.assertTrue(z1.opposé().getX() == -z1.getX() && z1.opposé().getY() == -z1.getY());
//
//}
//
